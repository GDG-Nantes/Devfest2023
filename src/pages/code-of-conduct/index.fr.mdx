...
Un personnel formé de la conférence peut être identifié par des t-shirts "DevFest Safe" (une photo sera disponible bientôt). Un stand "DevFest Safe" sera aussi mis en place sur l'espace lounge pour vous renseigner et vous accueillir en cas de besoins. Ce stand sera affiché sur le plan disponible sur votre badge. Le harcèlement et les autres infractions au code de conduite réduisent la valeur de notre événement pour tous. Nous voulons que vous soyez heureux lors de notre événement. Des gens comme vous font de notre événement un meilleur endroit.
...
Contacter un membre du personnel identifié par le t-shirt "DevFest Safe".
...
- Jean-François Garreau
  ...
  - jef@gdgnantes.com
- Le compte du DevFestNantes en mp sur Twitter 
